...
while 1:
	...
	if dist == -1:
		print("There is no token around me, I am not moving")
		exit()
	elif dist < d_th:
		print("mmmmmmmm, I can see that")
		R.grab()
		exit()
	elif -a_th <= rot_y <= a_th:
		print("Don't move, I am coming!!!")
		drive(10,0.5)
	elif rot_y < -a_th:
		print("Oh, my bad!!! Slighlty left")
		turn(-2,0.5)
	elif rot_y > a_th:
		turn(+2,0.5)
		print("Sorry my bad, you are right that I have to move right. I should be more attentive.")
